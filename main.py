...
student_name = os.getenv("STUDENT_NAME", "Власійчук Данило")
group_code = os.getenv("GROUP", "АІ-235")
run_mode = os.getenv("MODE", "eco")

print(f"--- ПІБ: {student_name} | Група: {group_code} | Режим: {run_mode} ---\n")
